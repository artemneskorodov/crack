...
static const sf::Vector2f   ScreenSize          = sf::Vector2f(
                                                    (float)WindowMode.width,
...
struct object_type_info_t {
    object_types_t type;
    crack_state_t (*updater    )(crack_t*,
                                 object_t*);
    crack_state_t (*constructor)(crack_t*,
                                 object_t*,
                                 const object_info_t*);
};
...
crack_state_t       decor_updater      (crack_t                *ctx,
                                        object_t               *obj);
...
static const object_type_info_t ObjectTypesInfo[] = {
    ...
    {OBJECT_DECOR,     decor_updater,   decor_constructor},
...
crack_state_t       button_move        (crack_t                *ctx,
                                        object_t               *obj);
...
crack_state_t       textbox_move       (crack_t                *ctx,
                                        object_t               *obj);
