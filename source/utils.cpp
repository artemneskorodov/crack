...
sf::Vector2f real_pos(const sf::Vector2f &rel_pos, const sf::Vector2f &screen_size, const sf::Vector2f &size) {
    return sf::Vector2f(rel_pos.x * screen_size.x, rel_pos.y * screen_size.y) * 0.01f - size * 0.5f;
}

bool is_object_focused(const sf::Vector2f &mouse, const sf::RectangleShape &box) {
...
bool box_intersect(const sf::Vector2f &tl1, const sf::Vector2f &tr1, const sf::Vector2f bl1, const sf::RectangleShape &box2) {
